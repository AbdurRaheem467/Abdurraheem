...
export class CheckoutPage {
  static render() {
    ...
    if (items.length === 0) {
      return `
        <div class="max-w-xl mx-auto px-4 py-24 text-center space-y-6">
          ...
          <h2 class="font-serif text-2xl font-medium text-white">Your Shopping Bag is Empty</h2>
          <p class="text-xs text-zinc-400">Please select a luxury timepiece before entering the acquisition checkout.</p>
          <a href="#shop" class="inline-block px-8 py-3 rounded-xl bg-[#d4af37] text-black font-semibold text-xs uppercase tracking-widest hover:brightness-110 transition-all">
